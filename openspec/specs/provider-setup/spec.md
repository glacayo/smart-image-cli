...
Guide users and agents through safe provider configuration, model discovery, model selection, and setup validation without leaking secrets or requiring provider-specific knowledge.
